...
// Code taken from https://github.com/ethz-asl/geodetic_utils/blob/master/geodetic_utils/include/geodetic_utils/geodetic_conv.hpp
...
class GeodeticConverter
{
 public:
  ...
  static void geodetic2Ecef(const double latitude, const double longitude, const double altitude, double* x,
                     double* y, double* z) 
  {
 ...
 Eigen::Matrix3d get_dcm_ecef2ned() const {return ecef_to_ned_matrix_; }
 Eigen::Matrix3d get_dcm_ned2ecef() const {return ned_to_ecef_matrix_; }
