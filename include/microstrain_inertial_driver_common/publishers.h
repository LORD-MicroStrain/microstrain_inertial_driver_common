...
public:
  ...
  Publisher<SbasInfoMsg>::SharedPtrVec         gnss_sbas_info_pub_     = Publisher<SbasInfoMsg>::initializeVec({GNSS1_SBAS_INFO_TOPIC, GNSS2_SBAS_INFO_TOPIC, RTK_SBAS_INFO_TOPIC});
