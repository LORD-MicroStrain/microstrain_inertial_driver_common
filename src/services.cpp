...
{
  {
    ...
    mip_base_get_device_information_service_ = configureService<MipBaseGetDeviceInformationSrv, GetDeviceInfo>("mip/base/get_device_information", &Services::mipBaseGetDeviceInformation);
  }
  {
    using namespace mip::commands_3dm;  // NOLINT(build/namespace)
    mip_3dm_capture_gyro_bias_service_ = configureService<Mip3dmCaptureGyroBiasSrv, CaptureGyroBias>("mip/three_dm/capture_gyro_bias", &Services::mip3dmCaptureGyroBias);
    mip_3dm_device_settings_save_service_ = configureService<EmptySrv, DeviceSettings>("mip/three_dm/device_settings/save", &Services::mip3dmDeviceSettingsSave);
    mip_3dm_device_settings_load_service_ = configureService<EmptySrv, DeviceSettings>("mip/three_dm/device_settings/load", &Services::mip3dmDeviceSettingsLoad);
  }
  {
    using namespace mip::commands_filter;  // NOLINT(build/namespace)
    mip_filter_reset_service_ = configureService<EmptySrv, Reset>("mip/ekf/reset", &Services::mipFilterReset);
  }
  /*
  {
